...
def khtest(txt, lang="km"):
    ''' Only tests text for conformance to Khmer encoding structure, reporting where
        errors are found. Middle Khmer supported (lang="xhm") but not very strictly. '''
    res = []
    passed = True
